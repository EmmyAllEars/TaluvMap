		...
		L.marker([-635,728], {icon: hubIcon}).bindPopup("<img class='border-fix' src='https://www.fromashesrisen.com/mediawiki/images/d/de/Anthyr_main_gate.png' width='300'></img><p align='center'>Anthyr <a href='https://www.fromashesrisen.com/wiki/Anthyr'>(Wiki link)</a></p><ul><li>Library</li><li>Shops with Vendors</li><li>Dragon's Breath Tavern and Inn</li><li>Job/Notice Board</li><li>The Moonstone Mask Brothel</li><li>Public Crafting Benches</li></ul>").addTo(hubGroup);
